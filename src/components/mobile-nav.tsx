          ...
          <div className="rounded-2xl bg-background ring-1 ring-border/50 shadow-lg overflow-hidden">
            ...
            {openTray === "extras" && (
              <TraySection>
                ...
                <TrayItem label="Foundations" href="/cardboard/foundations" active={pathname === "/cardboard/foundations"} onPress={() => navigate("/cardboard/foundations")} icon={pathname === "/cardboard/foundations" ? SwatchSolid : SwatchIcon} />
                <TrayItem label="Components" href="/cardboard/components" active={pathname === "/cardboard/components"} onPress={() => navigate("/cardboard/components")} icon={pathname === "/cardboard/components" ? Square3Stack3DSolid : Square3Stack3DIcon} />
              </TraySection>
            )}

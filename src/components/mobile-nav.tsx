  ...
  return (
    <>
      ...
      <nav className="mobile-nav fixed bottom-0 left-0 right-0 z-40 flex items-end justify-center px-6 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
        <div className="flex h-16 w-full items-center rounded-xl bg-background/80 supports-backdrop-filter:backdrop-blur-md ring-1 ring-border/60 shadow-lg overflow-hidden">
        {navItems.map((item) => {

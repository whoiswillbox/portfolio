...
export function ContentWorkspace({ children }: { children: React.ReactNode }) {
  ...
  const enabled = pathname !== "/who" && pathname !== "/conversations" && pathname !== "/" && pathname !== "/extracurriculars" && pathname !== "/technergetics" && pathname !== "/school" && !pathname.startsWith("/cardboard");
  ...
  const backTo = pathname.startsWith("/extracurriculars/music/")
    ...
    : pathname === "/resume"
    ? { href: "/technergetics", label: "Back" }
    : pathname.startsWith("/cardboard/foundations/")
    ? { href: "/cardboard/foundations", label: "Back" }
    : null;

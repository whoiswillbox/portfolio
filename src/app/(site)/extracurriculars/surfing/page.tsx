...
const MEDIA: MediaItem[] = [
  ...
  { type: "video", src: "/projects/surfing/backside-2-turn-combo-compressed.mp4",  label: "San Clemente · Trestles",   year: 2018 },
  { type: "video", src: "/projects/surfing/good-wrap-compressed.mp4",              label: "San Clemente · Trestles",   year: 2018 },
  { type: "video", src: "/projects/surfing/backside-vert-compressed.mp4",          label: "San Clemente · Trestles",   year: 2018 },
  { type: "video", src: "/projects/surfing/sands-drone-3-compressed.mp4",          label: "Santa Barbara · Sands",     year: 2017 },
  { type: "video", src: "/projects/surfing/sands-drone-compressed.mp4",            label: "Santa Barbara · Sands",     year: 2017 },
  { type: "video", src: "/projects/surfing/sands-drone-2-compressed.mp4",          label: "Santa Barbara · Sands",     year: 2017 },
...
export default function Surfing() {
  ...
  return (
    <ContentCard className="h-full overflow-auto">
      <article className="mx-auto w-full max-w-4xl px-6 pb-32 pt-16 max-sm:pt-32 max-sm:[@media(display-mode:standalone)]:pt-40">

          ...
          <div className="flex flex-col gap-2">
            <form onSubmit={submit} className="flex flex-col gap-3 sm:flex-row">
              <Input
                ...
                autoComplete="off"
                spellCheck={false}
                className="!h-16 min-h-16 flex-1 bg-background px-4 text-lg sm:!h-14 sm:min-h-14 sm:text-base"
              />
              <Button
                type="submit"
                size="lg"
                disabled={!password.trim() || submitting}
                className="!h-16 min-h-16 text-base sm:!h-14 sm:min-h-14 sm:w-40"
              >
